...
bool CDXTCImage::LoadFromFile (const char* filename)
{
	...
	return LoadFromMemory ((const BYTE*)pvMap, mappedFile.Size()); // @fix7
}

bool CDXTCImage::LoadHeaderFromMemory (const BYTE* c_pbMap, int iSize) // @fix7
{
	//////////////////////////////////////
	// start reading the file
	// from Microsoft's mssdk D3DIM example "Compress"
	DWORD dwMagic;
	if (iSize < sizeof (DWORD)) // @fix7
	{
		return false;
	}
...
//		return false;
	...
	if (iSize < sizeof (DDSURFACEDESC2)) // @fix7
	{
		return false;
	}
	...
	iSize -= sizeof (DDSURFACEDESC2); // @fix7
...
//////////////////////////////////////////////////////////////////////
bool CDXTCImage::LoadFromMemory (const BYTE* c_pbMap, int iSize) // @fix7
{
	if (!LoadHeaderFromMemory (c_pbMap, iSize)) // @fix7
	{
		return false;
	}
