...
enum EItemTypes
{
	...
	ITEM_QUEST,             //17
	ITEM_POLYMORPH,         //18
	ITEM_TREASURE_BOX,      //19//보물상자
	ITEM_TREASURE_KEY,      //20//보물상자 열쇠
	ITEM_SKILLFORGET,       //21
	ITEM_GIFTBOX,           //22
	ITEM_PICK,              //23
	ITEM_HAIR,              //24//머리
	ITEM_TOTEM,             //25//토템
	ITEM_BLEND,				//26//생성될때 랜덤하게 속성이 붙는 약물
	ITEM_COSTUME,			//27//코스츔 아이템 (2011년 8월 추가된 코스츔 시스템용 아이템)
	ITEM_DS,				//28 //용혼석
	ITEM_SPECIAL_DS,		//29 // 특수한 용혼석 (DS_SLOT에 착용하는 UNIQUE 아이템이라 생각하면 됨)
	ITEM_EXTRACT,			//30 추출도구.
	ITEM_SECONDARY_COIN,	//31 ?? 명도전??
	ITEM_RING,				//32 반지
	ITEM_BELT,				//33 벨트
};
...
{
	DRAGON_SOUL_INVENTORY_MAX_NUM = static_cast<int>(DS_SLOT_MAX) * static_cast<int>(DRAGON_SOUL_GRADE_MAX) * static_cast<int>(DRAGON_SOUL_BOX_SIZE),
};
