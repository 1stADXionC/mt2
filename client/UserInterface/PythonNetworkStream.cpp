...
class CMainPacketHeaderMap : public CNetworkPacketHeaderMap
{
	...
	public:
		CMainPacketHeaderMap()
		{
			...
			Set (HEADER_GC_SKILL_LEVEL_OLD,	CNetworkPacketHeaderMap::TPacketType (sizeof (TPacketGCSkillLevel), STATIC_SIZE_PACKET));
			...
			Set(HEADER_GC_MEMLEKET, TPacketType(sizeof(TPacketGCMemleketInfo), STATIC_SIZE_PACKET));
			Set(HEADER_GC_MEMLEKET_STATE, TPacketType(sizeof(TPacketGCMemleketState), STATIC_SIZE_PACKET));
#endif
